...
Самое простое что можно было сделать, скрипт с делением, также присутствует деление на 0

![python ](/10-monitoring-05-sentry/python.png)
[python script](/10-monitoring-05-sentry/script.png)
---
